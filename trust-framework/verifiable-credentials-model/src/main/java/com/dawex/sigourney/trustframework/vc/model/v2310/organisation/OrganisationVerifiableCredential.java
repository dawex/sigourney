...
public class OrganisationVerifiableCredential {
	@JsonLdProperty(value = "id", formatName = Format.ORGANISATION_VERIFIABLE_CREDENTIAL, mandatory = true)
	private final String id;

	@JsonLdProperty(value = "issuer", formatName = Format.ORGANISATION_ISSUER, mandatory = true)
