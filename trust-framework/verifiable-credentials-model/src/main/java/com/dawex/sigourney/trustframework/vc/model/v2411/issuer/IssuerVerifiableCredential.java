...
import static com.dawex.sigourney.trustframework.vc.model.v2411.serialization.Format.ISSUER_VERIFIABLE_CREDENTIAL;
...
public class IssuerVerifiableCredential extends BaseVerifiableCredential<IssuerCredentialSubject> {
	...
	@JsonLdProperty(value = "id", formatName = ISSUER_VERIFIABLE_CREDENTIAL)
	@Override
	public String getId() {
		return super.getId();
	}
