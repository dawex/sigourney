...
/**
 * <a href="https://docs.gaia-x.eu/ontology/development/enums/MIMETypes/">List of permissible values for MIMETypes</a>
 */
public enum MimeType {
	...
	public static Optional<MimeType> fromValue(String value) {
		return Arrays.stream(MimeType.values())
				.filter(mimeType -> mimeType.getValue().equalsIgnoreCase(value))
				.findAny();
	}
}
