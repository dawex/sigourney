...
class NotaryServiceFactoryTest {
	...
	void shouldCreateNotaryServiceV1() {
		...
		assertThat(NotaryServiceFactory.create(GaiaxVersion.V1, HttpClient.newBuilder(), new ObjectMapper(), "uri"))
				.isInstanceOf(NotaryServiceV1.class);
	}
	...
	void shouldCreateNotaryServiceV2() {
		...
		assertThat(NotaryServiceFactory.create(GaiaxVersion.V2, HttpClient.newBuilder(), new ObjectMapper(), "uri"))
				.isInstanceOf(NotaryServiceV2.class);
	}
}